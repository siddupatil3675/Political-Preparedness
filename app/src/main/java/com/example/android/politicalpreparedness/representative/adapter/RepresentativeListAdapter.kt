...
class RepresentativeListAdapter : ListAdapter<Representative, RepresentativeViewHolder>(RepresentativeViewHolder.RepresentativeDiffCallback) {
...
class RepresentativeViewHolder(val binding: ItemRepresentativesBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    companion object {
        fun from(parent: ViewGroup): RepresentativeViewHolder {
            val binding = ItemRepresentativesBinding.inflate(
